...
var wishlistIcons = document.querySelectorAll(".fa-regular.fa-heart");
...
//======FANCYBOX=======
$(document).ready(function () {
  $("[data-fancybox='blog-images']").fancybox({});
});

// brand-logo-swiper
document.addEventListener("DOMContentLoaded", function () {
  var sliderOptions = JSON.parse(
    document.getElementById("brandSlider1").dataset.sliderOptions
  );
